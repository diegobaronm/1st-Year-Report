...
\begin{figure}[ht]
	\centering
	\subfloat[]{\label{Fig7a}{\includegraphics[width=0.45\textwidth]{figures/Fig7a}}}\hfill
	\subfloat[]{\label{Fig7b}{\includegraphics[width=0.45\textwidth]{figures/Fig7b}}}
...
\begin{figure}[ht]
	\centering
	\subfloat[]{\label{Fig7a}{\includegraphics[width=0.50\textwidth]{figures/Fig10a}}}\hfill
	\subfloat[]{\label{Fig7b}{\includegraphics[width=0.50\textwidth]{figures/Fig10b}}}
	\caption{$\mreco$ distribution for the in between region (a) and the outside region (b).}
	\label{Fig10}
\end{figure}

In addition, for the $Z\to\tauh e$ final state two cuts are aimed to reject events where the $\tauh$ candidate is faked by an electron. First, the invariant mass of the electron 
