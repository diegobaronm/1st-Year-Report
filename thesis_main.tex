...
\documentclass[11pt,
  ...
  % enumerate and itemize. For this purpose we include the enumitem package and set itemsep=.5em, of course you can change this % BCOR is binding correction
...
\begin{document}
    ...
    \pagestyle{headings} % remove chapter name from top, page number at the bottom
    ...
    \input{chapters/2-TauPhysics}
    \input{chapters/3-LHCandATLAS}
